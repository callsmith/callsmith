...
/// (with a trailing directory separator). <see cref="ViewModels.RequestViewModel"/> uses this
/// to clear the editor if the currently-displayed request was inside the deleted item.
/// </summary>
