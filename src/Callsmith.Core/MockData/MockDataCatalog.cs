...
public static class MockDataCatalog
{
    ...
    [
        ...
        new("Name", "Job Title",    "e.g. Senior Software Engineer")         { GenerateFunc = f => f.Name.JobTitle() },        new("Name", "Job Area",       "e.g. Applications, Integration")       { GenerateFunc = f => f.Name.JobArea() },
        ...
        new("Internet", "Image URL",      "Random image URL (picsum.photos)")  { GenerateFunc = f => f.Image.PicsumUrl() },        new("Internet", "Protocol",       "http or https")                     { GenerateFunc = f => f.Internet.Protocol() },
        ...
        new("Address", "Longitude",           "GPS longitude e.g. -74.005974") { GenerateFunc = f => f.Address.Longitude().ToString("F6") },        new("Address", "Street Name",         "e.g. Main Street, Oak Ave")     { GenerateFunc = f => f.Address.StreetName() },
